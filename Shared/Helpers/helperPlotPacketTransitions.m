classdef helperPlotPacketTransitions < handle
    %helperPlotPacketTransitions Plots the live packet communication across
    %time and frequency for Bluetooth, WLAN, and coexistence nodes
    %
    %   helperPlotPacketTransitions(NODES,SIMULATIONTIME,Name=Value) creates
    ...
    %   time in seconds.
    %
    %   helperPlotPacketTransitions properties (Configurable as NV pair in
    %   constructor):
    %
    ...
    %% Constructor
    methods
        function obj = helperPlotPacketTransitions(nodes,simulationTime,varargin)
            ...
            [countCoex,countBluetooth,countWLAN,countIntWLAN] = deal(1);
            ...
            for idx = 1:numel(nodes)
                ...
                elseif isa(nodes{idx},"helperInterferingWLANNode")
                    ...
                    addlistener(obj.InterferingWLANNodes{countIntWLAN},"PacketTransmissionStarted",@(srcNode,eventData) objWeakRef.Handle.interferingWLANPlotCallback(srcNode,eventData));
    ...
    methods (Access=private)
        function initializeVisualization(obj)
            ...
            if obj.pNumWLANNodes+obj.pNumInterferingWLANNodes>0 && obj.pNumBREDRNodes+obj.pNumLENodes+obj.pNumLE6GHzNodes==0 % Only WLAN nodes
            ...
            elseif obj.pNumWLANNodes+obj.pNumInterferingWLANNodes==0 && obj.pNumBREDRNodes+obj.pNumLENodes+obj.pNumLE6GHzNodes>0 % Only Bluetooth nodes
            ...
            elseif obj.pNumWLANNodes+obj.pNumInterferingWLANNodes>0 && obj.pNumBREDRNodes+obj.pNumLENodes+obj.pNumLE6GHzNodes>0
